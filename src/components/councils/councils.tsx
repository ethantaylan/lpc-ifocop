        ...
        <div className=" d-flex w-100 flex-column">
          ...
          <p className={matches ? "p-2" : "p-4"}>
            ...
            <span className="bold">
              ...
              vêtements pour vous aider à créer le look parfait pour le
              printemps.{" "}
            </span>
            <br /> <br /> Que vous cherchiez des robes légères, des jupes
            fluides, des pantalons amples, des blouses colorées, des t-shirts
            imprimés ou des vestes légères, vous trouverez tout ce dont vous
            avez besoin ici. <br /> <br /> Notre équipe de stylistes et
            d'experts de la mode est à votre disposition pour vous aider à
            choisir
            <span className="bold">
              {" "}
            ...
            toutes vos questions, vous donner des conseils sur les tendances de
            la saison, et vous aider à trouver les pièces qui feront de votre
            garde-robe de printemps un succès. Alors, n'hésitez plus et explorez
            notre site pour trouver les vêtements printaniers parfaits pour
            vous. <br /> <br />{" "}
            <span className="bold">
